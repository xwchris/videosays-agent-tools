...
- 「我的技能」已显示「抖音文案提取技能」，标记「我创建的 / v1.1 / 扣子」，带中文简介并绑定 1 个 Agent。这里的 v1.1 是扣子平台版本，不是 npm CLI 版本。
- 已从条目菜单打开[上架资质申请问卷](https://bytedance.larkoffice.com/share/base/form/shrcn63MPiYq0AUI3rnB94hcsPf?from=navigation)，填写了技能说明、公开作品说明和账号资料，附上两个技能包及 MiniMax 公共市场截图。申请草稿尚缺联系手机号和虾评发布经历，**未提交**，更未提交商店审核。
- 申请资格通过后，仍需准备真实使用案例及完成技能审核；问卷提示资格审核预计 10 个工作日，以平台实际结果为准。
